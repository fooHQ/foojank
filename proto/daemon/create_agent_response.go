...
// CreateAgentResponse is a response to a CreateAgentRequest.
type CreateAgentResponse struct {
	Error error
}

// MarshalCbor encodes the response as a CBOR array: [error].
func (m *CreateAgentResponse) MarshalCbor(w io.Writer) error {
...
func (m *CreateAgentResponse) UnmarshalCbor(r io.Reader) error {
