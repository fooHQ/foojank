...
// CreateGatewayResponse is a response to a CreateGatewayRequest.
type CreateGatewayResponse struct {
	Error error
}

// MarshalCbor encodes the response as a CBOR array: [error].
func (m *CreateGatewayResponse) MarshalCbor(w io.Writer) error {
...
func (m *CreateGatewayResponse) UnmarshalCbor(r io.Reader) error {
